  ...
  const renderSubsGoal = () => (
    <div className="goal-progress-stack">
      <GoalProgressBar
        ...
        subtext={settings.subGoalSubtext || (streamGoals.topSubGifter ? `Top: @${streamGoals.topSubGifter.username} (${streamGoals.topSubGifter.amount})` : undefined)}
  ...
  const renderKicksGoal = () => (
    <div className="goal-progress-stack">
      <GoalProgressBar
        ...
        subtext={settings.kicksGoalSubtext || (streamGoals.topKicksGifter ? `Top: @${streamGoals.topKicksGifter.username} (${streamGoals.topKicksGifter.amount})` : undefined)}
