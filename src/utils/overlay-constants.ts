...
export const TIMERS = {
  ...
  WALKING_PACE_THRESHOLD: 10, // km/h — show minimap/speed when >= this (cycling/driving)
  MINIMAP_SPEED_MIN_READINGS: 3, // consecutive readings >= threshold required (was 5)
  MINIMAP_SPEED_MIN_DURATION_MS: 10 * 1000, // readings must span at least 10s (was 20s — minimap and speed appear together)
