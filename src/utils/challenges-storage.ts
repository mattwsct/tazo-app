...
const SOCIAL_TASKS = [
  'Start a conversation with a stranger and find out something interesting about them',
  "Ask a local for their favourite hidden spot in this area",
  "Try a street food you've never had before",
  'Ask someone to teach you a word or phrase in their language',
  'Take a photo with a local (with permission)',
  'Find the most unusual or interesting shop nearby and go inside',
  'Ask someone for a restaurant recommendation and actually go there',
  'Wave or say hi to 5 strangers',
  'Find out the name of a local landmark from someone on the street',
  'Get directions from a stranger and follow them somewhere new',
  'Interview a local about their daily routine',
  'Find a street performer or musician and tip them',
  'Ask a shopkeeper about the history of their shop',
  'Order something off the menu without reading it first',
  'Ask a local what they think tourists always get wrong about this place',
  'Start a conversation with someone at a café or food stall',
  'Find out what the locals do on weekends here',
  'Ask 3 different people for their favourite local dish',
  "Find someone who's lived here their whole life and ask them about the changes",
  'Ask a stranger to recommend the best view in the area',
];
