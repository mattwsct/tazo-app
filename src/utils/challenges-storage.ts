...
const SOCIAL_TASKS = [
  'Chat with a stranger and learn something interesting about them',
  'Ask a local for their favourite hidden spot nearby',
  'Try a street food you\'ve never had before',
  'Ask someone to teach you a local word or phrase',
  'Take a photo with a local (with permission)',
  'Find an unusual shop nearby and go inside',
  'Ask someone for a restaurant recommendation and go there',
  'Greet 5 strangers',
  'Ask a local to name a nearby landmark',
  'Ask a stranger for directions and follow them',
  'Ask a local about their daily routine',
  'Find a street performer and tip them',
  'Ask a shopkeeper about the history of their shop',
  'Order something off the menu without reading it',
  'Ask a local what tourists always get wrong here',
  'Strike up a conversation at a café or food stall',
  'Ask a local what they do on weekends',
  'Ask 3 people for their favourite local dish',
  'Find a long-time local and ask what\'s changed here',
  'Ask a stranger to recommend the best view nearby',
];
